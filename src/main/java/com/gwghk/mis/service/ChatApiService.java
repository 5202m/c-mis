...
public class ChatApiService{
    ...
    public ApiResult leaveRoom(String groupIds,String userIds, String systemCategory){
    	...
    	try {
    		...
    		if(StringUtils.isNotBlank(str)){
    			JSONObject obj=JSON.parseObject(str);
					return api.setCode(obj.getJSONObject("data").getBoolean("isOK")?ResultCode.OK:ResultCode.FAIL).setErrorMsg(obj.getString("msg"));//return api.setCode(obj.getBoolean("isOK")?ResultCode.OK:ResultCode.FAIL).setErrorMsg(obj.getString("error"));
    		}else{
    			return api.setCode(ResultCode.FAIL);
    		}
    	} catch (Exception e) {
