...
public class MemberService {
  ...
  public List<Member> getMemberListByMobiles(String[] mobiles, String groupType) {
    ...
    return memberDao
        .findListInclude(Member.class, query, "mobilePhone", "loginPlatform.chatUserGroup.$");
  }
   ...
   * 功能：设置禁言
   */
  public ApiResult saveUserGag(String groupType, String memberId, String groupId, String gagDate,
      String gagTips, String remark) {
  ...
  public ApiResult saveUserSetting(String memberId, String groupId, String type, boolean value,
      String remark, String clientGroup, String accountNo) {
    boolean isOk = memberDao
        .updateUserSetting(memberId, groupId, type, value, remark, clientGroup, accountNo);
    return new ApiResult().setCode(isOk ? ResultCode.OK : ResultCode.FAIL);
  }
   ...
   * 分页查询聊天室用户组信息
   */
  public Page<Member> getChatUserPage(DetachedCriteria<Member> dCriteria, Date onlineStartDate,
      Date onlineEndDate, Date createDateStart, Date createDateEnd) {
    Member member = dCriteria.getSearchModel();
    Query query = new Query();
    ...
    return memberDao
        .findPageInclude(Member.class, query, dCriteria, "loginPlatform.chatUserGroup.$",
            "mobilePhone", "updateDate");
  }
  ...
  public List<Member> getMemberByUserId(String[] userIds) {
    return memberDao.findListInclude(Member.class, Query.query(
        new Criteria()
            .andOperator(Criteria.where("loginPlatform.chatUserGroup.userId").in((Object[]) userIds)
  ...
  public List<Member> getMemberByUserIdGroupType(String[] userIds, String groupType) {
    ...
    query.addCriteria(criteria);
    return memberDao
        .findListInclude(Member.class, query, "loginPlatform.chatUserGroup.$", "mobilePhone");
  }
