...
<script type="text/javascript" src="<%=request.getContextPath()%>/jsp/chat/subscribe/subscribe.js" charset="UTF-8"></script>
      ...
      <table class="tableForm_L" style="margin-top:3px" width="99%" heigth="auto"  border="0" cellpadding="0" cellspacing="1">
        ...
        <tr>
          ...
          <td width="23%">
            ...
            <select class="easyui-combotree" name="analysts" id="subscribeAnalystsSelectId" style="width:250px;" data-options="cascadeCheck:false" multiple>
	        </select>
          </td>
        </tr>
        <tr>
